  ...
  return (
    <main className="container max-w-[660px] py-16 flex-1">
      ...
      <div className="prose-kisti font-bn max-w-none text-base leading-relaxed text-muted-foreground mb-10">
        <p>
          &apos;কিশতী&apos; একটি অলাভজনক চিন্তামূলক ব্লগ। রাষ্ট্র, ইতিহাস, দর্শন ও ধর্মতত্ত্বের চর্চাকে অব্যাহত রাখতে এবং লেখকদের অনুপ্রাণিত করতে আপনার অনুদান আমাদের সহায়তা করবে।
        </p>
      </div>
